...
class TicketTypePolicy
{
    ...
    public function create(User $user)
    {
        if($user->roles->contains('slug', 'staff')){//if user has staff then he can create
            return true;
        }elseif($user->permissions->contains('slug', 'create-ticket_type')){//if user has permission to create ticket type then he can create
            return true;
        }
        return false;
    }
    ...
    {   
        if($user->roles->contains('slug', 'staff')){//if user has staff role then he can edit
            return true;
        }elseif($user->permissions->contains('slug', 'edit-ticket_type')){//if user has permission to edit ticket type then he can edit
            return true;
        }
        return false;
    }
    ...
    public function update(User $user, TicketType $ticketType)
    {
        if($user->roles->contains('slug', 'staff')){//if user has staff role then he can update
            return true;
        }elseif($user->permissions->contains('slug', 'edit-ticket_type')){//if user has permission to edit ticket type then he can update
            return true;
        }
    ...
    public function delete(User $user, TicketType $ticketType)
    {
        if($user->roles->contains('slug', 'staff')){//if user has staff role then he can delete
            return true;
        }elseif($user->permissions->contains('slug', 'delete-ticket_type')){//if user has permission to delete ticket type then he can delete
            return true;
        }
        return false;
    }

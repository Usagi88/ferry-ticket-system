!(function (e) {
    ...
    function i(i, p) {
        ...
        function f() {
            ...
            return (
                d("h") && o.push(n), d("m") && o.push(r), d("s") && o.push(i), o
            );
        }
        function t() {
            var e,
            ...
            if (
                ...
                !(
                    (p.disabledDates &&
                        "d" === t &&
                        ((a = e),
                        !0 === p.disabledDates[a.format("YYYY-MM-DD")])) ||
                    (p.enabledDates &&
                        "d" === t &&
                        ((n = e),
                        !0 !== p.enabledDates[n.format("YYYY-MM-DD")])) ||
                    ...
                    (function () {
                        ...
                        for (
                            t
                                .eq(0)
                                .find("span")
                                .attr("title", p.tooltips.prevDecade),
                                t.eq(1).attr("title", p.tooltips.selectDecade),
                                t
                                    .eq(2)
                                    .find("span")
                                    .attr("title", p.tooltips.nextDecade),
                    ...
                    (function () {
                        ...
                        for (
                            a
                                .eq(0)
                                .find("span")
                                .attr("title", p.tooltips.prevCentury),
                                a
                                    .eq(2)
                                    .find("span")
                                    .attr("title", p.tooltips.nextCentury),
        ...
        function w(e) {
            ...
            if (
                ...
                for (
                    e
                        .minutes(
                            Math.round(e.minutes() / p.stepping) * p.stepping
                        )
                        .seconds(0);
                ...
                I.prop("disabled") ||
                    ...
                    (function () {
                        ...
                        for (
                            ...
                            e.append(
                                $("<th>").addClass("dow").text(t.format("dd"))
                            ),
                                t.add(1, "d");
        ...
        function P() {
            ...
            (q = e.replace(
                ...
                (B = p.extraFormats ? p.extraFormats.slice() : []).indexOf(e) <
                    0 &&
                    B.indexOf(q) < 0 &&
                    B.push(q),
                (Y =
        ...
        var E,
            ...
            X = {
                ...
                selectMonth: function (e) {
                    ...
                    H.month(t),
                        j === V
                            ? (w(E.clone().year(H.year()).month(H.month())),
                              p.inline || b())
                            : (o(-1), s()),
                        r("M");
                },
        ...
        if (
            ...
            (L.enabledDates = function (e) {
                if (0 === arguments.length)
                    return p.enabledDates
                        ? $.extend({}, p.enabledDates)
                        : p.enabledDates;
            ...
            (L.collapse = function (e) {
                ...
                return (
                    p.collapse === e || ((p.collapse = e), N && (b(), D())), L
                );
            }),
            (L.icons = function (e) {
            ...
            (L.viewMode = function (e) {
                ...
                return (
                    (p.viewMode = e), (j = Math.max(R.indexOf(e), V)), o(), L
                );
            }),
        ...
        ($.fn.datetimepicker = function (a) {
            ...
            if ("string" == typeof a)
                return (
                    ...
                    r ||
                    -1 < $.inArray(a, ["destroy", "hide", "show", "toggle"])
                        ? this
                        : t
                );

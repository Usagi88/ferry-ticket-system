!(function (t, e) {
        ...
        g = {
            ...
            show(e) {
                var i,
                    ...
                    a,
                    n = this.settings,
                    r = "mix" == n.mode && !n.enforceWhitelist,
                    l = !n.whitelist || !n.whitelist.length,
                    d = "manual" == n.dropdown.position;
                if (
                    ((e = void 0 === e ? this.state.inputText : e),
                    (!l || r || n.templates.dropdownItemNoMatch) &&
                        !1 !== n.dropdown.enable &&
                    ...
                    if (
                        ...
                        (this.suggestedListItems =
                            this.dropdown.filterListItems.call(this, e)),
                        e &&
                ...
                callbacks: {
                    onKeyDown(t) {
                        var e = this.DOM.dropdown.querySelector(
                            ...
                            i = this.dropdown.getSuggestionDataByNode.call(
                                this,
                                e
                            );
                        switch (t.key) {
                            ...
                            case "Up":
                                ...
                                t.preventDefault(),
                                    ...
                                    e ||
                                        ((s =
                                            this.DOM.dropdown.content.children),
                                        (e =
                                            s[
                                                "ArrowUp" == t.key ||
                                                "Up" == t.key
                                    ...
                                    (i =
                                        this.dropdown.getSuggestionDataByNode.call(
                                            this,
                                            e
                                        )),
                                    this.dropdown.highlightOption.call(
                            ...
                            case "Tab":
                                if (
                                    ...
                                    t.preventDefault();
                                    var a = this.dropdown.getMappedValue.call(
                                        this,
                                        i
                                    );
                                    return (
            ...
            filterListItems(t, e) {
                ...
                if (!t || !u.length)
                    return (
                        d.duplicates
                            ...
                            : c.filter(
                                  (t) =>
                                      !this.isTagDuplicate(o(t) ? t.value : t)
                              )
                    ).slice(0, p);
                function v(t, e) {
                    return e
                ...
                for (
                    r = h.caseSensitive ? "" + t : ("" + t).toLowerCase();
                    m < c.length;
                    m++
                ) {
                    i = c[m] instanceof Object ? c[m] : { value: c[m] };
                    let t = !Object.keys(i).some((t) => u.includes(t))
                        ? ["value"]
                        : u;
                    if (
                        (h.fuzzySearch && !e.exact
                            ...
                            : (s = t.some((t) => {
                                  ...
                                  return (
                                      ...
                                      e.exact ? s == r : 0 == s.indexOf(r)
                                  );
                              })),
                        (n =
                            !d.duplicates &&
                            this.isTagDuplicate(o(i) ? i.value : i)),
                        s && !n && p-- && g.push(i),
                        0 == p)
                    )
                        break;
            ...
            createListHTML(t) {
                return r([], t)
                    .map((t, e) => {
                        ...
                        t.value = i && "string" == typeof i ? a(i) : i;
                        var s = this.settings.templates.dropdownItem.call(
                            this,
                            t
                        );
                        return (s = s
                            .replace(
                                /\s*tagifySuggestionIdx=(["'])(.*?)\1/gim,
                                ""
                            )
                    ...
                    switch (t.key) {
                        ...
                        case "Backspace":
                            ...
                            var a,
                                ...
                                c = i(this.DOM.input.innerHTML),
                                p = this.getTagElms();
                            if ("edit" == this.settings.backspace && g)
                                return (
                                    (a =
                                        1 == r.anchorNode.nodeType
                                            ? null
                                ...
                                ((l || g) && 1 == r.anchorNode.nodeType
                                    ? (n =
                                          0 == r.anchorOffset
                                              ...
                                              : p[r.anchorOffset - 1])
                                    : l
                                    ? (n = r.anchorNode.nextElementSibling)
                                    : g && (n = g),
                                3 == r.anchorNode.nodeType &&
                                    !r.anchorNode.nodeValue &&
                                    r.anchorNode.previousElementSibling &&
                                    t.preventDefault(),
                                (g || l) && !this.settings.backspace)
                            )
                            ...
                            if (
                                ...
                                return void this.placeCaretAfterNode(s(n));
                            clearTimeout(h),
                                (h = setTimeout(() => {
                                    var t = document.getSelection(),
                                        e = i(this.DOM.input.innerHTML),
            ...
            onMixTagsInput(t) {
                ...
                if (
                    ...
                    if (
                        ...
                        (l || s < this.state.mixMode.matchedPatternCount) &&
                            (n = !1);
            ...
            onEditTagInput(t, e) {
                ...
                o || !0 !== t.originalIsValid || (l = !0),
                    ...
                    this.trigger("edit:input", {
                        tag: i,
                        index: s,
                        data: r({}, this.value[s], { newValue: n }),
    ...
    return (
        (m.prototype = {
            ...
            applySettings(t, e) {
                c.templates = this.templates;
                var i = (this.settings = r({}, c, e));
                ...
                if (
                    ...
                    ["whitelist", "blacklist"].forEach((e) => {
                        ...
                        s &&
                            (s = s.split(i.delimiters)) instanceof Array &&
                            (i[e] = s);
                    }),
                    "autoComplete" in e &&
                        !o(e.autoComplete) &&
                        ((i.autoComplete = c.autoComplete),
                ...
                if (a) {
                    if (!(o instanceof Object && "editable" in o) || o.editable)
                        return (
                            ...
                            e.skipValidation ||
                                (h = this.editTagToggleValidity(t, o.value)),
                            (a.originalIsValid = h),
            ...
            replaceTag(t, e) {
                (e && e.value) || (e = t.__tagifyTagData),
                    e.__isValid &&
                        1 != e.__isValid &&
                        r(e, this.getInvalidTagAttrs(e, e.__isValid));
            ...
            input: {
                set(t = "", e = !0) {
                    ...
                    (this.state.inputText = t),
                        e && (this.DOM.input.innerHTML = a("" + t)),
            ...
            selectTag(t, e) {
                if (
                    ...
                    return (
                        this.input.set.call(
                            this,
                            e[this.settings.tagTextProp || "value"],
                            !0
                        ),
                        this.state.actions.selectOption &&
                          ...
                          : ("select" == a.mode && (e = !1),
                            ...
                            t.forEach((t) => {
                                ...
                                if (
                                    ...
                                    r(
                                        o,
                                        this.getInvalidTagAttrs(t, t.__isValid),
                                        { __preInvalidData: l }
                                    ),
            ...
            prefixedTextToTag(t) {
                ...
                return (
                    (this.state.tag = null),
                    this.trigger("add", r({}, { tag: e }, { data: t })),
                    e
                );
            },
            appendTag(t) {
            ...
            getMixedTagsAsString() {
                var t = "",
                    i = this,
                    s = this.settings.mixTagsInterpolator;
                return (
                    (function a(n) {
                            ...
                            if (1 == n.nodeType) {
                                if (
                                    n.classList.contains(
                                        i.settings.classNames.tag
                                    ) &&
                                    i.tagData(n)
                                ) {
                                    if (i.tagData(n).__removed) return;
                                    return void (t +=
                                        s[0] +
                                        JSON.stringify(
                                            e(i.tagData(n), i.dataProps)
                                        ) +
                                        s[1]);
                                }
                                "BR" != n.tagName ||
                                (n.parentNode != i.DOM.input &&

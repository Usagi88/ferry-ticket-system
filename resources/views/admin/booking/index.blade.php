...
@section('content')
    ...
    @section('js_booking_create_alert')
        <script>
    ...
    <div class="bookingIndexGridContainer">
            ...
            <div class="cardNew card-icon-bg card-icon-bg-primary o-hidden mb-4">
                <div class="card-body text-center">
                    ...
                    <div class="content">
                        ...
                        <p class="lead text-primary-black text-24 mb-2">{{$bookings->count()}}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="tableCreateBtn">
            <a href="/admin/booking/create" class="btnTest btn-primaryTest rippleTest" role="button" aria-pressed="true">Create Booking</a>
        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="datatableActionButton">
                                                <a href="/admin/booking/{{ $booking['id'] }}" data-toggle="tooltip" data-placement="auto" title="Show"><i class="far fa-eye"></i></a>
                                                <a href="/admin/booking/{{ $booking['id'] }}/edit" data-toggle="tooltip" data-placement="auto" title="Edit"><i class="far fa-edit"></i></a>
                                                <a href="javascript:void(0)" data-bookingID="{{$booking['id']}}" onclick="deleteBooking(this)" data-toggle="tooltip" data-placement="auto" title="Delete"><i class="far fa-trash-alt"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach

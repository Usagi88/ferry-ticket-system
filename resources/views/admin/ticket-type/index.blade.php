            ...
            <div class="cardNew card-icon-bg card-icon-bg-primary o-hidden mb-4">
                <div class="card-body text-center">
                    ...
                    <div class="content">
                        ...
                        <p class="lead text-primary-black text-24 mb-2">{{$ticket_types->count()}}</p>
                    </div>
                </div>
            </div>
        </div>
        
        <div class="tableLabel">Ticket Types</div>
        <div class="tableCreateBtn">
            <div class="createBtnWidth">
                <a href="/admin/ticket-type/create" class="btnTest btn-primaryTest rippleTest" role="button" aria-pressed="true">Create Ticket Type</a>
            </div>
        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="datatableActionButton">
                                        <a href="/admin/ticket-type/{{ $ticket_type['id'] }}" data-toggle="tooltip" data-placement="auto" title="Show"><i class="far fa-eye"></i></a>
                                        <a href="/admin/ticket-type/{{ $ticket_type['id'] }}/edit" data-toggle="tooltip" data-placement="auto" title="Edit"><i class="far fa-edit"></i></a>
                                        <a href="javascript:void(0)" data-ticket_typeID="{{$ticket_type['id']}}" onclick="deleteTicketType(this)" data-toggle="tooltip" data-placement="auto" title="Delete"><i class="far fa-trash-alt"></i></a>
                                    </div>
                                </td>
                            </tr>
                        @endforeach

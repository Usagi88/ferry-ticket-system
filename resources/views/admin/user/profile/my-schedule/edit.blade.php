...
@section('content')
        ...
        <div class="gridUserCreateFirstRow">
            <div class="element-wrapper">
                <div class="element-box">
                   <form method="POST" action="/admin/user/{{$user->id}}/profile/my-schedule/{{ $schedule->id }}">
                        @method('PATCH')
                        @csrf()
                        <h5 class="form-header">Edit Schedule</h5>
                        <div class="form-desc">Edit schedule or vessel</div>
    ...
    @section('js_my_schedule_edit_datetimepicker')
        <script defer>

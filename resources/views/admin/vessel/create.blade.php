...
@section('content')
        ...
        <div class="gridUserCreateFirstRow">
            <div class="element-wrapper">
                <div class="element-box">
                   <form method="POST" action="/admin/vessel" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <h5 class="form-header">Create Vessel</h5>
                        <div class="form-desc">Create vessels with vessel type</div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8"><input type="number" name="seat_capacity" class="form-control" placeholder="Seat Capacity" value="{{ old('seat_capacity') }}" required></div>
                        </div>
                        <div class="form-group row">
                            <label class="col-form-label col-sm-4" for="">Max Accompanied Cargo</label>   
                            <div class="col-sm-8"><input type="number" name="max_accompanied_cargo" class="form-control" placeholder="Max Accompanied Cargo" value="{{ old('max_accompanied_cargo') }}" required></div>
                        </div>
                        <div class="form-group row">
                            <label class="col-form-label col-sm-4" for="">Max Unaccompanied Cargo</label>
                            <div class="col-sm-8"><input type="number" name="max_unaccompanied_cargo" class="form-control" placeholder="Max Unaccompanied Cargo" value="{{ old('max_unaccompanied_cargo') }}" required></div>
                        </div>
    ...
    @section('js_vessel_create_select')
        <script>
